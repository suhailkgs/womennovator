...
class AdminIncubationController  extends Controller
{
    ...
    {
        $incubationDatas  =  DB::table('incubations')->join('sectors','sectors.id','incubations.industry')->
        select('incubations.*','sectors.sectorname')->get();
        ($incubationDatas);
        return view('backEnd.incubatee.index',compact('incubationDatas'));
    }
   ...
   /* public function update(Request $request, $id = '')
    ...
    public function destroy($id = '')
    {
           try {
            ...
            DB::table('incubations')->where('id',$id)->delete();
