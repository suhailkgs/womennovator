...
class ProductsController extends Controller
{
    ...
    public function index()
    {
      //  dd(auth()->user()->id);
        ...
        return view('backEnd.product.index',compact('productDatas'));
    }
       ...
       // dd($request);
        ...
        $listing = Listing::latest()->get();
          if ($request->ajax()) {
            ...
            return view('backEnd.product.create',compact('category','listing'));
        }
    }
    ...
    public function edit($id = '')
    {
        ...
        return view('backEnd.product.edit', compact('product','productDatas','id','category','listing'));
    }
    ...
    public function update(Request $request, $id = '')
    {
        ...
        try {
           ...
           // dd($files); die;
            ...
            return redirect('admin/product')->with('success', $output);
        } catch (Exception $e) {
            DB::rollBack();
            Log::emergency("File:" . $e->getFile() . "Line:" . $e->getLine() . "Message:" . $e->getMessage());
            report($e);
