...
/*multiselect End*/
    ...
    <div class="text-center">
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-lg-10 mx-auto">
                  <form id="contact-form" class="contact-form" action="{{url('add/masteruser')}}" method="post">
                      @csrf
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                            <label>7. My Domain Expertise</label>
                         ...
                         <div class="col-md-12" style="margin-top:20px;"><label>9. Your Password  <span style="font-size:12px;">(Minimum 6 characters required)</span></label></div>
                         <div class="col-md-6">
                           <div class="form-group">
                               
                            <input class="form-control " placeholder="Password" name="password" id=""
                            type="password" >
                           </div>
                        </div>
                         <div class="col-md-6">
                             <div class="form-group">
                                <input class="form-control " placeholder="Confirm Password" name="confirm_password" id=""
                                type="password" >
                         ...
                         <div class="col-md-12">
                            <label>10. How did you hear about us? </label>
                         </div>
...
<!--pop-up End-->
  ...
  @if(!empty(Session::get('user_id')) && Session::get('user_id') != NULL)
<script>
$(function() {
