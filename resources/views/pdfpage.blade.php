        ...
        <div class="pdf-sec">
            <div class="container">
                <div class="pdf-content">
                    <iframe id="iframe" src="{{$pdf->pdf_store ??''}}#toolbar=0"></iframe>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   ...
   <img src="https://i.pinimg.com/originals/f6/65/6a/f6656aa6fdb6b8f905dea0bcc2d71dd8.gif" alt="processing..." />
       ...
       <form id="contact-form" class="form-prevent-mutiple-submits" method="post" action="{{ url('add/pdfview/')}}" enctype="multipart/form-data">
     ...
     <div class="form-group">
      ...
      @enderror
         ...
         <div class="modal-footer">
           ...
           <button  class="btn-ok button-prevent-mutiple-submits"  type="submit">Save</button>
