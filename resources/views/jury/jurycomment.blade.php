                    ...
                    <div class="main-content-body main-content-body-contacts card custom-card" style="display: block !important">
                        ...
                        <div class="main-contact-info-body p-4">
                            ...
                            <form method="post" action="{{ url('jury/jurycomment/save')}}"
                               ...
                               $comt_edit= App\Models\Eventcomment::commentedit($_GET['eventid'],$_GET['userid'],$comment->id ??'');
                                ...
                                <div class="row row-sm">
                                    ...
                                    <div class="col-11">
                                        <div class="form-group mg-b-0">
                                            ...
                                            <textarea class="form-control summernote" name="comment" rows="3" placeholder="">{!!$comment->comment ?? ''!!}</textarea>
                            ...
                            @if($stat==!NULL)
                                ...
                                <div class="row row-sm">
                                    <div class="d-flex pagination wd-100p">
                                        <button type="submit"
                                        class="ml-auto btn btn-main-primary pd-x-20 mg-t-10">Update Comment</button>
