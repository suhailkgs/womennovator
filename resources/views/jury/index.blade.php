		...
		<div class="card">
			<div class="card-header pb-0">
				<div class="d-flex justify-content-between">
					<h4 class="card-title pt-2">Latest Ratings</h4>
			...
			<div class="rating-scroll ps ps--active-y">
				...
				$user = DB::table('markingevents')
						->leftjoin('users','users.id','markingevents.user_id')
						->leftjoin('events','events.id','markingevents.event_id')
						->where('markingevents.jury_id',auth()->user()->id)
						->select('markingevents.*','users.name','events.event_name')
						->orderBy('markingevents.id','DESC')
						->take(5)->get();			
			...
			@foreach ($user as $users)
				...
				<div class="pl-3 pr-3 py-3 border-bottom">
					<div class="media mt-0">
						...
						<div class="media-body">
							<div class="d-flex">
								<h6 class="mt-0 mb-0 font-weight-semibold "  style="margin: 0 auto; width: 100px;">
				...
				<div class="pl-3 pr-3 py-3 border-bottom">
					<div class="media mt-0">
						<div class="d-flex mr-3">
							<a href="#">
								<img class="media-object avatar brround w-7 h-7" alt="64x64" src="{{ url('backEnd/img/active.png')}}">
							</a>
						</div>
						...
						<div class="media-body">
							<div class="d-flex">
								<h6 class="mt-0 mb-0 font-weight-semibold ">
									
									{{$users->name}}</h6>
								<span class="tx-12 ml-auto">
									@for($i=0;$i<$users->marks;$i++)
							...
							<div class="d-flex">
								<p class="tx-12 text-muted mb-0">{{$users->event_name}}</p>
								<small class="ml-auto text-right">{{$users->marks}} ratings</small>
							</div>
	...
	<div class="col-lg-12 col-xl-4 col-sm-12">
		<div class="card">
			<div class="card-header pb-0 pt-4">
				<div class="d-flex justify-content-between">
					<h4 class="card-title mg-b-10">Top Ongoing Events</h4>
					<i class="mdi mdi-dots-horizontal text-gray"></i>
				</div>
				</div>
				<hr>
			<div class="card-body p-0 m-scroll mh-350 mt-2">
				<div class="list-group projects-list" style="height: 334px;">
					@foreach($event as $eventData)
					<a href="{{url('/jury/eventuserlist/'.$eventData->id)}}"  class="list-group-item list-group-item-action flex-column align-items-start border-top-0">
						<div class="d-flex w-100 justify-content-between">
							<h6 class="mb-1 font-weight-semibold ">{{ $eventData->event_name}}</h6>
							
							<small class="text-danger"><i class="fa fa-caret-down mr-1"></i>1 days ago</small>
						</div>
						<p class="mb-0 text-muted mb-0 tx-12">Started : {{ date('F d,Y', strtotime($eventData->start_date)) }} </p>
						<p class="mb-0 text-muted mb-0 tx-12">End : {{ date('F d,Y', strtotime($eventData->end_date)) }}</p>
						{{-- <small class="text-muted">{!! $eventData->description !!}</small> --}}
					</a>
				  @endforeach
				</div>
			</div>
			...
			<div class="card-body p-0">
				<div class="activity Activity-scroll">
					<div class="activity-list">
						<img src="{{ url('jury/img/faces/6.jpg')}}" alt="" class="img-activity">
					   ...
					   <img src="{{ url('jury/img/faces/9.jpg')}}" alt="" class="img-activity">
						<div class="time-activity">
							<div class="item-activity">
						...
						</div> <img src="{{ url('jury/img/faces/3.jpg')}}" alt="" class="img-activity">
						<div class="time-activity">
							<div class="item-activity">
						...
						</div> <img src="{{ url('jury/img/faces/4.jpg')}}" alt="" class="img-activity">
						<div class="time-activity">
							<div class="item-activity ">
						...
						</div> <img src="{{ url('jury/img/faces/5.jpg')}}" alt="" class="img-activity">
						<div class="time-activity">
							<div class="item-activity">
						...
						</div> <img src="{{ url('jury/img/faces/6.jpg')}}" alt="" class="img-activity">
						<div class="time-activity">
							<div class="item-activity">
						...
						</div> <img src="{{ url('jury/img/faces/16.jpg')}}" alt="" class="img-activity">
						<div class="time-activity">
							<div class="item-activity">
							<p class="mb-0"><span class="h6 mr-1">John Payne</span><span class="text-muted tx-13"> Add a new projects</span> <span class="h6 ml-1 added-project text-success">Free PSD Template</span></p><small class="text-muted ">3 days ago</small> </div>
						</div> <img src="{{ url('jury/img/faces/10.jpg')}}" alt="" class="img-activity">
