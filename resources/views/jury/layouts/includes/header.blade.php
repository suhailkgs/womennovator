    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            ...
            <div class="responsive-logo">
                <a href="index.html"><img src="{{ url('jury/img/brand/logo-white.png')}}" class="logo-1"></a>
                <a href="index.html"><img src="{{ url('jury/img/brand/logo.png')}}" class="logo-11"></a>
                <a href="index.html"><img src="{{ url('jury/img/brand/favicon-white.png')}}" class="logo-2"></a>
                <a href="index.html"><img src="{{ url('jury/img/brand/favicon.png')}}" class="logo-12"></a>
            </div>
              ...
              <!-- 	<div class="dropdown  nav-item main-header-message ">
                 ...
                 <div class="dropdown-menu">
                        ...
                        <div class="main-message-list chat-scroll">
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="  drop-img  cover-image  " data-image-src="{{ url('jury/img/faces/3.jpg')}}">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image" data-image-src="{{ url('jury/img/faces/2.jpg')}}">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image" data-image-src="{{ url('jury/img/faces/9.jpg')}}">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image" data-image-src="{{ url('jury/img/faces/12.jpg')}}">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image" data-image-src="{{ url('jury/img/faces/5.jpg')}}">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
               ...
               <!-- <div class="dropdown nav-item main-header-notification">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <a class="profile-user d-flex" href=""><img src="{{ Auth::user()->photo ??'' }}"  alt="user-img" class="rounded-circle mCS_img_loaded"><span></span></a>

                    <div class="dropdown-menu">
                        <div class="main-header-profile header-img">
                            <div class="main-img-user"><img alt="" src="{{ Auth::user()->photo ??'' }}" ></div>
