...
<aside class="main-sidebar app-sidebar sidebar-scroll">
    <div class="main-sidebar-header">
        <a class="desktop-logo logo-light active"  href="{{url('faces/home')}}" class="text-center mx-auto"><img style="width:80px;" src="{{ url('backEnd/img/Womennovator.png')}}"></a>
  ...
  <!-- <div class="sidebar-navs">
    ...
    <div class="main-sidebar-body">
        <ul class="side-menu ">
            <li class="slide">
                <a class="side-menu__item" href="{{url('faces/home')}}"><i class="side-menu__icon fe fe-airplay"></i><span
                            class="side-menu__label">Dashboard</span></a>
            </li>
           <li class="slide">
                <a class="side-menu__item" href="{{url('faces/events')}}"><i
           ...
           <!-- <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="index.htm#"><i
                            class="side-menu__icon fe fe-calendar"></i><span class="side-menu__label">Blog</span><i
                            class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{url('faces/blog/create')}}">Add Blog</a></li>
                    <li><a class="slide-item" href="{{url('faces/blog')}}">Blog List</a></li>
                </ul>
            </li>-->
          
            <li class="slide">
              
                <a class="side-menu__item" href="{{url('faces/editprofile')}}"><i class="side-menu__icon far fa-user"></i><span
            ...
            <li class="slide">
                ...
                <a class="side-menu__item" href="http://wedistributors.womennovators.com/"><i class="side-menu__icon fe fe-shopping-cart"></i><span
                    class="side-menu__label">We-Marketplace </span></a>
            </li>
