...
/*multiselect End*/
      ...
      <div id="page-banner-area" class="page-banner-area" style="background-image:url('	https://womennovators.com/globalsummit/images/hero_area/banner_bg.jpg')">
			...
			<div class="page-banner-title">
				<div class="text-center">
					<h2>Apply For Association Partner</h2>
    ...
    <div class="text-center">
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-lg-10 mx-auto">
                  <form id="contact-form" class="contact-form" action="{{url('add/associative-partner/'.$id)}}" method="post">
                      @csrf
                     <div class="error-container"></div>
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                               <label>1.  Association/Industry Name <span>*</span></label>
                              <input class="form-control form-control-name" placeholder="Name" name="association_name" id="f-name"
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>2. Address<span></span></label>
                                <textarea  class="form-control form-control-subject" placeholder="Address" name="address" id="subject"
                               ></textarea>
                            </div>
                         </div>
                       
                       <!--  <div class="col-md-12" style="margin-top:20px;"><label>3. Your Social Media Links  <span></span></label></div>
                         <div class="col-md-6">
                           <div class="form-group">
                        ...
                        -->
                         ...
                         <div class="col-md-6">
                            <label>4. Where did you get reference from?  <span></span></label>
                           <div class="form-group">
                         ...
                         <div class="col-md-6">
                            <label>5. Chamber Contact No? <span></span></label>
                             <div class="form-group">
                                <input class="form-control " placeholder="Chamber Contact No" name="chamber_contact" id=""
                                 type="text" >
                             </div>
                         </div>
                         ...
                         <div class="col-md-6">
                            <label > 6. No of members till Date :</label>
                            <br>
                             <div class="form-group">
                                <input class="form-control " placeholder="No of members till Date" name="member_no" id=""
                                type="text" >
                             
                             </div>
                         </div>
                         <div class="col-md-6">
                            <label> 7. Alternative Designated Person :</label>
                             <div class="form-group ">
                                <input class="form-control " placeholder="Person Name" name="designated_person" id=""
                                type="text" >
                         ...
                         <div class="col-md-6">
                            <label> 8. Email id :</label>
                             <div class="form-group">
                                <input class="form-control " placeholder="Email id" name="designated_person_email" id=""
                                type="text" >
                         ...
                         <div class="col-md-6">
                            <label> 9. Contact no : </label>
                             <div class="form-group">
                                <input class="form-control " placeholder="Contact no " name="contact_no" id=""
                                type="number" >
                                
                             </div>
                         </div>
                         <div class="col-md-6">
                            <label> 10. In Which sector You Are Into?</label>
                             <div class="form-group">
                                <input class="form-control " placeholder="Sector " name="sector" id=""
                                type="text" >
                         ...
                         <div class="col-md-6">
                            <label>10. Other Branches in India (if any) ?</label>
                            <div class="form-group">
                                <input class="form-control " placeholder="Other Branches " name="other_branch" id=""
                                type="text" >
                                
                             </div>
                         </div>
                         <div class="col-md-12">
                            <label>11. Any Women focused event done ?</label>
                             <div class="form-group " >
                                <div class="gender"><input type="radio" class="form-control " name="focused_event" value="Yes" >Yes</div>
                                <div class="gender"><input type="radio" class="form-control " name="focused_event" value="No">No</div>
                                <div class="gender"><input type="radio" class="form-control " name="focused_event" value="Others">Others</div>
                             </div>
                         </div>
                         <div class="col-md-12">
                            <label>12. Would you like to organize a local event for Womennovator 2019?</label>
                             <div class="form-group ">
                                <div class="gender"><input type="radio" class="form-control " name="local_event" value="Yes" >Yes</div>
                                <div class="gender"><input type="radio" class="form-control " name="local_event" value="No">No</div>
                                <div class="gender"><input type="radio" class="form-control " name="local_event" value="Maybe">Maybe</div>
                             </div>
                         </div>
                         <div class="col-md-12">
                            <label>13. Any Inhouse infrastructure facility available?</label>
                             <div class="form-group ">
                                <div class="gender"><input type="radio" class="form-control " name="inhouse" value="Yes" >Yes</div>
                                <div class="gender"><input type="radio" class="form-control " name="inhouse" value="No">No</div>
                         ...
                         <div class="col-md-6">
                            <label style="padding-top: 20px;">14. Which kind of program you want to be partner with us :</label>
                         ...
                         <div class="col-md-6">
                            <label style="padding-top: 20px;">15.  Upload Your logo :</label>
                             <div class="form-group ">
