            ...
            <div class="p-5 wd-md-100p">
                <div class="main-signin-header">
                  <h2><img src="{{ url('backEnd/img/Womennovator.png')}}" style="width: 30%;height: 70%;" class="main-logo"></h2>
                    ...
                    <form method="POST" method="post" action="{{ url('otpemail/store')}}" enctype="multipart/form-data">
               ...
               <div style="text-align: center"> <a href="{{url('/emailotp/resend/'.$id)}}" style="color: #D8457D;font-weight: 500;">Resend Otp</a></div>
