...
#pageloader img
{
  left: 50%;
   ...
   <img src="https://i.pinimg.com/originals/f6/65/6a/f6656aa6fdb6b8f905dea0bcc2d71dd8.gif" alt="processing..." />
                  ...
                  <form id="contact-form" class="contact-form" action="{{url('awardee-add')}}" method="post" enctype="multipart/form-data">
                  @csrf 
                  <div class="error-container"></div>
                     <div class="row">
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                           <div class="form-group">
                               <label>4. Upload Video * <small style="    font-size: 64%;">upload a 60 second’s Video | File Type mp4 | File Size upto 150 MB</small></label>
    ...
    Filevalidation = () => {
        ...
        if (fi.files.length > 0) {
            for (const i = 0; i <= fi.files.length - 1; i++) {
                ...
                if (file >= 153600) {
                    alert(
                      "File too Big, please select a file less than 150 mb");
                      $("#file").val("");
                } else if (file < 2048) {
                    alert(
