...
<aside class="main-sidebar app-sidebar sidebar-scroll">
    <div class="main-sidebar-header">
        ...
        <a class="desktop-logo icon-logo active" href="index.html"><img src="{{ url('backEnd/img/0km.png')}}" class="logo-icon"></a>
    ...
    <div class="main-sidebar-body">
        <ul class="side-menu ">
            <li class="slide">
                <a class="side-menu__item" href="{{url('buyer/home')}}"><i class="side-menu__icon fe fe-airplay"></i><span
                            class="side-menu__label">Dashboard</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" href="{{url('buyer/profile')}}"><i class="side-menu__icon fe fe-airplay"></i><span
