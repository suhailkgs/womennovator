                            ...
                            <table class="table table-hover table-bordered mb-0 text-md-nowrap text-lg-nowrap text-xl-nowrap table-striped ">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="image-grouped"><img class="profile-img brround" alt="profile image" src="{{ url('backEnd/img/faces/11.jpg')}}"><img class="profile-img brround " alt="profile image" src="{{ url('backEnd/img/faces/12.jpg')}}"><img class="profile-img brround" alt="profile image"
                                                    src="{{ url('backEnd/img/faces/2.jpg')}}"></div>
                                        </td>
                                        <td>Web Design</td>
                                        <td>01 Jan 2020</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="image-grouped"><img class="profile-img brround" alt="profile image" src="{{ url('backEnd/img/faces/16.jpg')}}"><img class="profile-img brround " alt="profile image" src="{{ url('backEnd/img/faces/8.jpg')}}"><img class="profile-img brround" alt="profile image"
                                                    src="{{ url('backEnd/img/faces/7.jpg')}}"></div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="image-grouped"><img class="profile-img brround" alt="profile image" src="{{ url('backEnd/img/faces/3.jpg')}}"><img class="profile-img brround " alt="profile image" src="{{ url('backEnd/img/faces/12.jpg')}}"><img class="profile-img brround" alt="profile image"
                                                    src="{{ url('backEnd/img/faces/15.jpg')}}"></div>
                                        </td>
                                        <td>Web Development</td>
                                        <td>15 March 2020</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="image-grouped"><img class="profile-img brround" alt="profile image" src="{{ url('backEnd/img/faces/7.jpg')}}"><img class="profile-img brround " alt="profile image" src="{{ url('backEnd/img/faces/6.jpg')}}"><img class="profile-img brround" alt="profile image"
                                                    src="{{ url('backEnd/img/faces/16.jpg')}}"></div>
                                        </td>
                                        <td>Android</td>
                                        <td>15 March 2020</td>
                                        <td><span class="badge badge-success-gradient">Ongoing</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="image-grouped"><img class="profile-img brround" alt="profile image" src="{{ url('backEnd/img/faces/8.jpg')}}"><img class="profile-img brround " alt="profile image" src="{{ url('backEnd/img/faces/11.jpg')}}"><img class="profile-img brround" alt="profile image"
                                                    src="{{ url('backEnd/img/faces/15.jpg')}}"></div>
                                        </td>
                                        <td>Android</td>
                                        <td>15 March 2020</td>
                    ...
                    <div class="card-body p-0">
                        <div class="activity Activity-scroll">
                            <div class="activity-list">
                                <img src="{{ url('backEnd/img/faces/6.jpg')}}" alt="" class="img-activity">
                                ...
                                <img src="{{ url('backEnd/img/faces/9.jpg')}}" alt="" class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity">
                                ...
                                </div> <img src="{{ url('backEnd/img/faces/3.jpg')}}" alt="" class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity">
                                ...
                                </div> <img src="{{ url('backEnd/img/faces/4.jpg')}}" alt="" class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity ">
                                ...
                                </div> <img src="{{ url('backEnd/img/faces/5.jpg')}}" alt="" class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity">
                                ...
                                </div> <img src="{{ url('backEnd/img/faces/6.jpg')}}" alt="" class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity">
                                ...
                                </div> <img src="{{ url('backEnd/img/faces/16.jpg')}}" alt="" class="img-activity">
                                <div class="time-activity">
                                    <div class="item-activity">
                                        <p class="mb-0"><span class="h6 mr-1">John Payne</span><span class="text-muted tx-13"> Add a new projects</span> <span class="h6 ml-1 added-project text-success">Free PSD Template</span></p><small class="text-muted ">3 days ago</small>                                        </div>
                                </div> <img src="{{ url('backEnd/img/faces/10.jpg')}}" alt="" class="img-activity">
