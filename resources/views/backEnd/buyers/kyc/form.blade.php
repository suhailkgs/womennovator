...
<div class="container-fluid">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div>
            <h4 class="content-title mb-2">Kyc Details</h4>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @csrf
                                ...
                                <label>Business Pancard<span class="text-danger">*</span></label>
                                <!-- <input type="text" class="form-control" name="name" value={{ $kyc->name ??''}}> -->
                                <input type="text"  name="pancard" class="form-control" value="{{ $kyc->pancard ??''}}" >
                            </div>
								 <div class="form-group">
                                <label>Business GST Number<span class="text-danger">*</span></label>
                                <!-- <input type="text" class="form-control" name="name" value={{ $kyc->name ??''}}> -->
                                <input type="text"  name="gst" class="form-control" value={{ $kyc->gst ??''}} >
                            </div>
                            <div class="form-group">
                                <label>Account Holder Name<span class="text-danger">*</span></label>
                                <!-- <input type="text" class="form-control" name="name" value={{ $kyc->name ??''}}> -->
                                <input type="text"  name="name" class="form-control" value={{ $kyc->name ??''}} >
                            </div>
                            <div class="form-group">
