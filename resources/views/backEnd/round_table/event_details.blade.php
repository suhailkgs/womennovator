                      ...
                      <table class="table display table-bordered table-striped table-hover">
                        <tbody>
                          <tr>
                            ...
                            <td>{{ $round_table_event->round_table_title ?? '-----' }}</td>
                            <td></td>
                          </tr>
                          <tr>
                            <td><b>Event Poster : </b></td>
                            <td>
                                @if ($round_table_event->round_table_poster)
                                <img src="{{ asset('we/images/'.$round_table_event->round_table_poster) }}" alt="Event Poster" width="100" height="100"></td>
                                @else
                                No Image
                                @endif
                          ...
                          <tr>
                            ...
                            <td>{{ $round_table_event->round_table_mode ?? '-----' }}</td>
                          </tr>
                          <tr>
                            <td><b>Event Start Date : </b></td>
                            <td> {{ Carbon\Carbon::parse($round_table_event->round_table_start_date)->format('d/m/Y') ?? '-----' }} </td>
                          </tr>
                          <tr>
                            <td><b>Event End Date : </b></td>
                            <td> {{ Carbon\Carbon::parse($round_table_event->round_table_end_date)->format('d/m/Y') ?? '-----' }} </td>
                          </tr>
                          <tr>
                            <td><b>Event Start Time : </b></td>
                            <td> {{ Carbon\Carbon::parse($round_table_event->round_table_from)->format('h:i A') ?? '-----' }} </td>
                          </tr>
                          <tr>
                            <td><b>Event End Time : </b></td>
                            <td> {{ Carbon\Carbon::parse($round_table_event->round_table_to)->format('h:i A') ?? '-----' }} </td>
                          </tr>
                          <tr>
                            <td><b>Community Name : </b></td>
                            <td>{{ $round_table_event->community_name ?? '-----' }}</td>
                          </tr>
                          <tr>
                            <td><b>Creator Name : </b></td>
                            <td>{{ $round_table_event->creator_id ?? '-----' }}</td>
                          </tr>
                          <tr>
                            <td><b>State : </b></td>
                            <td>{{ $round_table_event->state_name ?? '-----' }}</td>
                          </tr>
                          <tr>
                            <td><b>City :</b></td>
                            <td>{{ $round_table_event->city_name ?? '-----' }}</td>
                          </tr>
                          <tr>
                            <td><b>Event Sector : </b></td>
                            <td>{{ $round_table_event->sectorname ?? '-----' }}</td>
                          </tr>
                          <tr>
                            <td><b>Event Type :</b></td>
                            <td>{{ $round_table_event->type ?? '-----' }}</td>
                          </tr>

                          <tr>
                            <td><b>Description : </b></td>
                            <td>{!! $round_table_event->round_table_desc ?? '-----' !!}</td>
                            <td></td>
                          </tr>
                          <tr>
