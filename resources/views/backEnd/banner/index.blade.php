        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mg-b-0 mt-2">banner</h4>
                    ...
                    <table class="table text-md-nowrap" id="example1">
                        <thead>
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0"> Bannerimage</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                              <img src="{{asset('image')}}/{{$bannerData->bannerimage}}" style="max-width:60px;"></td>
                                
                                <td><a href="{{route('banner.edit', $bannerData->id)}}" class="btn ripple btn-primary text-white btn-icon"><i class="fe fe-edit"></i></a></td>
                                <td><form action="{{ route('banner.destroy', $bannerData->id) }}" method="POST">
