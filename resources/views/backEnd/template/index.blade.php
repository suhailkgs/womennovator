        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mg-b-0 mt-2">template</h4>
                    <i class="mdi mdi-dots-horizontal text-gray"></i>
                    <a href="{{url('admin/template/create')}}"  class="ml-auto btn btn-main-primary pd-x-20 mg-t-10">Add Template</a>
                </div>
                </div>
            <div class="card-body">
                    ...
                    <table class="table text-md-nowrap" id="example1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('template.edit', $templateData->id)}}" class="btn ripple btn-primary text-white btn-icon"><i class="fe fe-edit"></i></a></td>
                                <td><form action="{{ route('template.destroy', $templateData->id) }}" method="POST">
