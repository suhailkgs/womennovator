...
<div class="my-auto page page-h" style="" >
                ...
                <div class="main-signin-header">
                  <!-- <h2><img src="{{ url('backEnd/img/0km.png')}}" style="width: 30%;height: 70%;" class="main-logo"></h2>
                   ...
                   <hr style="background-color:purple">
                    <form method="POST" action="{{url('/resellers/insert')}}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            placeholder="Enter  password again " style="border-color:black;">
                                ...
                                @enderror
                                <br/>
                                <a class="btn btn-primary" href="{{url('/resellers/login')}}" role="button" style="float:right;">Login</a>
