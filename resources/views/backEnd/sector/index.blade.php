            ...
            <div class="card">
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0 mt-2">sector List</h4>
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('sector.destroy', $sectorData->id) }}" method="POST">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Add Sector</h6><button aria-label="Close" class="close" data-dismiss="modal"
            ...
            <form method="post" action="{{ route('sector.store')}}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="details-form-field form-group row">
                        <label for="name" class="col-sm-3 col-form-label font-weight-600">Sector Name :</label>
                        <div class="col-sm-6">
                            <input id="name" class="form-control" name="sectorname" type="text">
                        </div>
