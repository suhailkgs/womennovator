        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mg-b-0 mt-2">brand</h4>
                ...
                <div class="table-responsive">
                    <table class="table text-md-nowrap" id="example1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$brandData->title}}</td>
                               <!-- <td>{{$brandData->position}}</td>-->
                                <td>@if($brandData->status==1)
                              ...
                              <!-- <td>{{$brandData->link}}</td>-->
                                    <td><img src="{{$brandData->image}}" alt="Responsive image" ></td>
                                <td><a href="{{route('brand.edit', $brandData->id)}}" class="btn ripple btn-primary text-white btn-icon"><i class="fe fe-edit"></i></a></td>
                                <td><form action="{{ route('brand.destroy', $brandData->id) }}" method="POST">
