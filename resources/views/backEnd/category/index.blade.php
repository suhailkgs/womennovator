                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>@if($categoryData->status==1)
                                    ...
                                    @endif</td>
                                <td><a href="{{route('category.edit', $categoryData->id)}}" class="btn ripple btn-primary text-white btn-icon"><i class="fe fe-edit"></i></a></td>
                                <td><form action="{{ route('category.destroy', $categoryData->id) }}" method="POST">
