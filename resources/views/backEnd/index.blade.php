				...
				<div class="row row-sm">
					<div class="col-xl-3 col-md-6 col-lg-6 col-sm-6">
						<div class="card">
							...
							<div class="card-body">
								<div class="plan-card text-center">
									<i class="fas fa-users text-primary plan-icon"></i>
									<h6 style="color: #031b4e;" class="text-drak text-uppercase mt-2">Jury</h6>
                                <h2 style="color: #031b4e;" class="mb-2">{{ $jury }}</h2>
								</div>
                            </div>
                            </a>
						</div>
					...
					<div class="col-xl-3 col-md-6 col-lg-6 col-sm-6">
						<div class="card">
							...
							<div class="card-body">
								<div class="plan-card text-center">
									<i class="fas fa-archive plan-icon text-primary"></i>
									<h6 style="color: #031b4e;"  class="text-drak text-uppercase mt-2">Event</h6>
                                <h2 style="color: #031b4e;"  class="mb-2">{{ $event }}</h2>
								</div>
                            </div>
                            </a>
						</div>
					...
					<div class="col-xl-3 col-md-6 col-lg-6 col-sm-6">
						<div class="card">
							...
							<div class="card-body">
								<div class="plan-card text-center">
									<i class="mdi mdi-account-multiple plan-icon text-primary"></i>
									<h6 style="color: #031b4e;"  class="text-drak text-uppercase mt-2"> User</h6>
                                <h2 style="color: #031b4e;"  class="mb-2">{{ $user }}</h2>
								</div>
                            </div>
                            </a>
						</div>
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="plan-card text-center">
									<i class="fas fa-phone plan-icon text-primary"></i>
									<h6 style="color: #031b4e;" class="text-drak text-uppercase mt-2">Total Enquiry</h6>
                                <h2 style="color: #031b4e;" class="mb-2">0</h2>
								</div>
                            </div>
                            </a>
						</div>
