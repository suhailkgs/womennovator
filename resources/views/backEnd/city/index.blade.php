            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0 mt-2">City List</h4>
                        <i class="mdi mdi-dots-horizontal text-gray"></i>
                                        <a  href="{{url('/admin/city/create')}}" ><i class="fe fe-plus"></i><img
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route('city.edit', $cityData->id)}}"
                                            class="btn ripple btn-primary text-white btn-icon"><i
                                                class="fe fe-edit"></i></a></td>
                                    <td>
                                        <form action="{{ route('city.destroy', $cityData->id) }}" method="POST">
