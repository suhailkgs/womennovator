...
<div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0 mt-2">Join the Squad List</h4>
    ...
    <span>Diet chart for pre and post covid</span> ,
    ...
    <span>meal to the patient in home isolation or quarantine</span> ,
    @elseif($category->category_id  == 10 )
    <span>Covid councelling</span> ,
    ...
    @endif
                                    ...
                                    <td><a href="{{route('joinsquad.edit', $appreciationData->id)}}" class="btn ripple btn-primary text-white btn-icon"><i class="fe fe-edit"></i></a></td>
                                    <td><a href="{{url('/admin/joinsquaddetails/'.$appreciationData->id)}}" 
