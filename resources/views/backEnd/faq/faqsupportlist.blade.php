                    ...
                    <table class="table text-md-nowrap" id="example1">
                        <thead>
                            <tr>
                              ...
                              <th class="wd-15p border-bottom-0"> Query</th> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{date('d-m-Y', strtotime($faqData->created_at))}}</td>
                                <td><form action="{{ url('admin/faqsupportlist/delete', $faqData->id) }}" method="POST">
