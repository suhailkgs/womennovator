        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mg-b-0 mt-2">FAQ</h4>
                    ...
                    <table class="table text-md-nowrap" id="example1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$faqData->faqques ??''}}</td>
                               
                                <td>
                                  {{$faqData->faqans}}</td>
                                  <td>
                                  {{date('d-m-Y', strtotime($faqData->created_at))}}</td>
                                
                               
                               
                                <td><a href="{{route('faq.edit', $faqData->id)}}" class="btn ripple btn-primary text-white btn-icon"><i class="fe fe-edit"></i></a></td>
                                <td><form action="{{ route('faq.destroy', $faqData->id) }}" method="POST">
