        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mg-b-0 mt-2">Award List</h4>
                            ...
                            <tr>
                                <td>{{$award->name}}</td>
                                 ...
                                 <td>
                                    ...
                                    src="{{asset('backEnd/image/award_image/'.$award->image)}}">
                                </td>
                                <td>
                                    {{$award->start}}
                                </td>
                                ...
                                <td><a href="{{route('award.edit', $award->id)}}" class="btn ripple btn-primary text-white btn-icon"><i class="fe fe-edit"></i></a></td>
                                <td><form action="{{ route('award.destroy', $award->id) }}" method="POST">
