        ...
        <div class="card">
            <div class="card-header pb-0">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title mg-b-0 mt-2">package</h4>
                            ...
                            <tr>
                                ...
                                <td>{{$packageData->amount}}</td>
                                    ...
                                    <td><img alt="Responsive image" class="img-thumbnail wd-100p wd-sm-70"
                                        src="{{$packageData->image}}"></td>
                                        <td>{!! $packageData->description !!}</td>
                                        <td>@if($packageData->status==1)
                                            <span class="badge badge-success">Active</span>
                                            @else
                                            <span class="badge badge-danger">Inactive</span>
                                            @endif</td>
                                        <td><a href="{{route('package.edit', $packageData->id)}}" class="btn ripple btn-primary text-white btn-icon"><i class="fe fe-edit"></i></a></td>
                                <td><form action="{{ route('package.destroy', $packageData->id) }}" method="POST">
