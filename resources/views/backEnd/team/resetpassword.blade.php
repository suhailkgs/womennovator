        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="@if(Request::is('admin/resetpassword/*'))
                    {{ url('admin/password/update/'.$id) }} @endif" enctype="multipart/form-data">
                        @csrf  
                        ...
                        <div class="row row-sm">
                            <div class="col-4">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control " type="text" name="email" value="{{ $teammember->email ?? ''}}" >
