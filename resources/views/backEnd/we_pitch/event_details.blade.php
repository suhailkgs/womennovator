                      ...
                      <table class="table display table-bordered table-striped table-hover">
                        <tbody>
                          <tr>
                            ...
                            <td>{{ $we_pitch_event->we_pitch_title ?? '-----' }}</td>
                            <td></td>
                          </tr>
                          <tr>
                            <td><b>Event Poster : </b></td>
                            <td>
                                @if ($we_pitch_event->we_pitch_poster)
                                <img src="{{ asset('we/images/'.$we_pitch_event->we_pitch_poster) }}" alt="Event Poster" width="100" height="100"></td>
                                @else
                                No Image
                                @endif
                          ...
                          <tr>
                            ...
                            <td>{{ $we_pitch_event->we_pitch_mode ?? '-----' }}</td>
                          </tr>
                          <tr>
                            <td><b>Event Start Date : </b></td>
                            <td> {{ Carbon\Carbon::parse($we_pitch_event->we_pitch_start_date)->format('d/m/Y') ?? '-----' }} </td>
                          </tr>
                          <tr>
                            <td><b>Event End Date : </b></td>
                            <td> {{ Carbon\Carbon::parse($we_pitch_event->we_pitch_end_date)->format('d/m/Y') ?? '-----' }} </td>
                          </tr>
                          <tr>
                            <td><b>Event Start Time : </b></td>
                            <td> {{ Carbon\Carbon::parse($we_pitch_event->we_pitch_from)->format('h:i A') ?? '-----' }} </td>
                          </tr>
                          <tr>
                            <td><b>Event End Time : </b></td>
                            <td> {{ Carbon\Carbon::parse($we_pitch_event->we_pitch_to)->format('h:i A') ?? '-----' }} </td>
                          </tr>
                          <tr>
                            <td><b>Community Name : </b></td>
                            <td>{{ $we_pitch_event->community_name ?? '-----' }}</td>
                          </tr>
                          <tr>
                            <td><b>Creator Name : </b></td>
                            <td>{{ $we_pitch_event->creator_id ?? '-----' }}</td>
                          </tr>
                          <tr>
                            <td><b>State : </b></td>
                            <td>{{ $we_pitch_event->state_name ?? '-----' }}</td>
                          </tr>
                          <tr>
                            <td><b>City :</b></td>
                            <td>{{ $we_pitch_event->city_name ?? '-----' }}</td>
                          </tr>
                          <tr>
                            <td><b>Event Sector : </b></td>
                            <td>{{ $we_pitch_event->sectorname ?? '-----' }}</td>
                          </tr>
                          <tr>
                            <td><b>Event Type :</b></td>
                            <td>{{ $we_pitch_event->type ?? '-----' }}</td>
                          </tr>

                          <tr>
                            <td><b>Description : </b></td>
                            <td>{!! $we_pitch_event->we_pitch_desc ?? '-----' !!}</td>
                            <td></td>
                          </tr>
                          <tr>
