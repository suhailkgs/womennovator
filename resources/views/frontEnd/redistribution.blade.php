...
<div class="rs-breadcrumbs breadcrumbs-overlay">
                <div class="breadcrumbs-img">
                    <img src="{{ url('/frontEnd/images/breadcrumbs/5.jpg')}}" alt="Breadcrumbs Image">
                </div>
            </div>
                    ...
                    @if(session()->has('success'))
                        ...
                        @endif
                         <div class="sec-title text-center mb-30">
                            <h2 class="title mb-10">Register Now !!</h2>
                            <div class="styled-form">  
                            <form method="post" action="{{url('/redistribution/store')}}" enctype="multipart/form-data">
                            @csrf
                            <div>
                                    <ul>
                             ...
                             <!-- Form Group -->
                                ...
                                <!-- Form Group -->
                                <div class="form-group col-lg-12 mb-25">
                                <h6 class="form-group col-lg-6" style="color: #ff5421; text-align:left;"><strong>Company/Business/Shop Name</strong></h6>
                                        <input type="text"  name="storename" value="" placeholder="Enter Company/Business/Shop Name">
                                        @error('storename')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="form-group col-lg-12 mb-25">
                                <h6 class="form-group col-lg-2" style="color: #ff5421; text-align:left;"><strong>Logo</strong></h6>
                                <input class="form-control" name="logo"  placeholder=""  id="" type="file" style="background:hidden;" >
                                        @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
                                ...
                                <h6 class="form-group col-lg-2" style="color: #ff5421; text-align:left;"><strong>Pincode </strong></h6>
                                        <input type="text"  name="pincode" value="" placeholder="Enter Pincode">
                                        @error('pincode')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                 ...
                                 <div class="form-group col-lg-12 mb-25">
                                <h6 class="form-group col-lg-6" style="color: #ff5421; text-align:left;"><strong>Nature Of Business </strong></h6>
                                 ...
                                 <div class="form-group col-lg-12 mb-25">
                                <h6 class="form-group col-lg-2" style="color: #ff5421; text-align:left;"><strong>Website </strong></h6>
                                        <input type="text"  name="website" value="" placeholder="Enter your Website">
                                        @error('website')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                 ...
                                 <!-- Form Group -->
                                 <div class="form-group col-lg-12 mb-25">
                                 <h6 class="form-group col-lg-6" style="color: #ff5421; text-align:left;"><strong>Describe Your Business</strong></h6>
                                <textarea class="form-control " style="padding:6px 30px;" type="text"  name="dscrp"  placeholder="Describe Your Business"> 
                                        </textarea>
                                        @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                <input class="form-control key" name="product_image[]"  placeholder="Choose Photo"  id="key" type="file" style="background:hidden;" required>
                                        @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
