        ...
        <div class="main-signin-header">
          ...
          <form method="POST" action="{{ route('user.registration') }}">
            ...
            <div class="form-group">
              <input type="name" class="form-control form-rounded @error('name') is-invalid @enderror" name="name" required
                autocomplete="name" autofocus placeholder="Enter your Name" style="border-color:black;">
            ...
            <div class="form-group">
              <input type="email" class="form-control form-rounded @error('email') is-invalid @enderror" name="email"
            ...
            <div class="form-group">
              ...
              {{-- <input type="password" id="password-confirm"
                class="form-control form-rounded @error('password') is-invalid @enderror" name="password_confirmation"
                required autocomplete placeholder="Enter  password again " style="border-color:black;">
              ...
              <a class="btn btn-primary float-right" href="{{ route('user.login') }}">Back</a>
          </form>
        </div>
