    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            ...
            <div class="responsive-logo">
                <a href="#"><img src="{{ url('influencers/img/brand/logo.png')}}" class="logo-1"></a>
                <a href="#"><img src="{{ url('influencers/img/brand/logo.png')}}" class="logo-11"></a>
                <a href="#"><img src="{{ url('influencers/img/brand/logo.png')}}" class="logo-2"></a>
                <a href="#"><img src="{{ url('influencers/img/brand/logo.png')}}" class="logo-12"></a>
            </div>
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="main-message-list chat-scroll">
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="  drop-img  cover-image  " data-image-src="{{ url('influencers/img/influencers/3.jpg')}}">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image" data-image-src="{{ url('influencers/img/influencers/2.jpg')}}">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image" data-image-src="{{ url('influencers/img/influencers/9.jpg')}}">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image" data-image-src="{{ url('influencers/img/influencers/12.jpg')}}">
                            ...
                            <a href="#" class="p-3 d-flex border-bottom">
                                <div class="drop-img cover-image" data-image-src="{{ url('influencers/img/influencers/5.jpg')}}">
                                    <span class="avatar-status bg-teal"></span>
                                </div>
                                <div class="wd-90p">
                                    <div class="d-flex">
               ...
               <!-- <div class="dropdown nav-item main-header-notification">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <a class="profile-user d-flex" href="">
                       ...
                       <img src="{{ Auth::user()->picture ??'' }}"  alt="user-img" class="rounded-circle mCS_img_loaded"><span></span></a>
                        @else
                    ...
                    <div class="dropdown-menu">
                        <div class="main-header-profile header-img">
                            <div class="main-img-user"><img alt="" src="{{ Auth::user()->picture ??'' }}" ></div>
